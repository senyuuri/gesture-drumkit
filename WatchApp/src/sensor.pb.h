...
#define SensorMessage_init_default               {0, 0, {0, 0, 0}, 0, {0, 0, 0}}
#define SensorMessage_init_zero                  {0, 0, {0, 0, 0}, 0, {0, 0, 0}}

/* Field tags (for use in manual encoding/decoding) */
#define SensorMessage_sensor_type_tag            1
#define SensorMessage_data_tag                   2
#define SensorMessage_timing_tag                 3

/* Struct field encoding specification for nanopb */
extern const pb_field_t SensorMessage_fields[4];

/* Maximum encoded size of messages (where known) */
#define SensorMessage_size                       59
